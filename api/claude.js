...
export default async function handler(req, res) {
  ...
  try {
    ...
    const ACT_LABEL = { outline: 'ให้ AI คิดโครงเรื่อง', prompts: 'สร้าง Prompt', meta: 'สร้างชื่อ/แคปชั่น', review: 'สรุปผลตรวจคลิป', metricRead: 'อ่านตัวเลขจากภาพสถิติ', deepAnalysis: 'วิเคราะห์เชิงลึก', plan: 'วางแผนกลยุทธ์', rival: 'ถอดสูตรคู่แข่ง', productFit: 'วิเคราะห์สินค้า', other: 'ใช้ AI' };
